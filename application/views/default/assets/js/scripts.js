...
var cart = {
    'add': function(product_id, quantity) {
        $.ajax({
            url: location.hostname + '/cart/add',
            type: 'post',
...
$(".qtyplus").click(function(){     
     $(this).parent().parent().find(":text[id='p_quantity']").val( Number($(this).parent().parent().find(":text[id='p_quantity']").val()) + 1 );
    });

$(".qtyminus").click(function(){
     if($(this).parent().parent().find(":text[id='p_quantity']").val()>1)
      $(this).parent().parent().find(":text[id='p_quantity']").val( Number($(this).parent().parent().find(":text[id='p_quantity']").val()) - 1 );
