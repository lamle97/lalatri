(function($) {
    ...
    $(document).ready(function() {
        ...
        $("#price-range").ionRangeSlider({
            ...
            from: 200000,                       // overwrite default FROM setting
            to: 600000,                         // overwrite default TO setting
            type: "double",                 // slider type
            step: 10000,                     // slider step
        ...
        $('#read-comment-link').on('click', function () {
            ...
            $('html, body').animate({
                scrollTop: $("div.ps-product__content").offset().top
            }, 2000);

            return false;
        });    
        $('a[href="#recovery"]').on('click', function () {
            $('div#login-form').addClass('hidden');
            $('div#recovery-form').removeClass('hidden');
        });
        $('a[href="#login"]').on('click', function () {
            $('div#recovery-form').addClass('hidden');
