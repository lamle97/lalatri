  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      ...
      <form action="manufacturers/delete" method="post">
      	<a class="btn btn-info tip-top" data-original-title="Add new" href="manufacturers/add"><i class="icon-plus"></i></a>
      	<button class="btn btn-danger tip-top" data-original-title="Delete" type="submit"><i class="icon-trash"></i></button>
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5>List Manufacturers</h5>
          </div>
            ...
            <table class="table table-bordered table-striped with-check text-center">
              ...
              <?php
                foreach ($manufacturers as $value) {
                  echo '<tr>';
                  echo '<td><input type="checkbox" name="item[]" value="'. $value['manufacturer_id'] .'"/></td>';
                  echo '<td>'. $value['name'] .'</td>';
                  echo '<td>'. $value['sort_order'] .'</td>';
                  echo '<td><a class="btn btn-info" href="manufacturers/edit/'. $value['manufacturer_id'] .'"><i class="icon-edit"></i> Edit</a></td>';
                  echo '</tr>';
                }
              ?>
              </tbody>
