  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      ...
      <form action="categories/delete" method="post">
      	<a class="btn btn-info tip-top" data-original-title="Add new" href="categories/add"><i class="icon-plus"></i></a>
            ...
            <table class="table table-bordered table-striped with-check text-center">
              ...
              <?php
                foreach ($categories as $value) {
                  echo '<tr>';
                  echo '<td><input type="checkbox" name="item[]" value="'. $value['category_id'] .'"/></td>';
                  echo '<td>'. $value['name'] .'</td>';
                  echo '<td>'. $value['sort_order'] .'</td>';
                  echo '<td><a class="btn btn-info" href="categories/edit/'. $value['category_id'] .'"><i class="icon-edit"></i> Edit</a></td>';
                  echo '</tr>';
                }
              ?>
              </tbody>
